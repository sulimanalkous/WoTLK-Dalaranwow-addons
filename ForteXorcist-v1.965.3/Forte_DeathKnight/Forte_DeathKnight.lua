...
if FW.CLASS == "DEATHKNIGHT" then
	...
	if ST then
		...
		ST:RegisterSpell(55095,	1,015,1,ST.DEFAULT); -- Frost Fever
		...
		ST:RegisterSpell(55078,	1,015,1,ST.DEFAULT); -- Blood Plague
			ST:RegisterSpellModTlnt(55078,49562,1,3); -- 49562 = Epidemic
			ST:RegisterSpellModTlnt(55078,49562,2,6);
			
		ST:RegisterSpell(45524,	1,010,0,ST.UNIQUE); -- Chains of Ice
		ST:RegisterSpell(47528,	1,004,0,ST.UNIQUE); -- Mind Freeze
		ST:RegisterSpell(48680,	1,005,0,ST.UNIQUE); -- Strangulate
