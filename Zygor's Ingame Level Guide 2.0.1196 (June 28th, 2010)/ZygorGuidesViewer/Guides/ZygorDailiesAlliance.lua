...
ZygorGuidesViewer:RegisterGuide("Zygor's Alliance Dailies Guides\\Dalaran\\Fishing Dailies",[[
	...
	step //1
		...
		..accept Monsterbelly Appetite##13836 |daily |or
...
ZygorGuidesViewer:RegisterGuide("Zygor's Alliance Dailies Guides\\Howling Fjord\\Howling Fjord Pre-Quests",[[
	author support@zygorguides.com
	description This guide section contains the pre-quests to unlock the daily quest in the Kamagua and Steel Gate regions of Howling Fjord.  The Westguard Keep region of Howling Fjord does not have any pre-quests to unlock the daily quest that is available there.
	step //1	
...
ZygorGuidesViewer:RegisterGuide("Zygor's Alliance Dailies Guides\\Icecrown\\Icecrown Full Zone Quest Path (Includes Regular Dailies Pre-Quests)",[[
	...
	step //80
		'The entrace to the cave starts here, go inside the cave|goto 57.0,57.3,0.3|c
	step //81
		goto 56.0,57.6
...
ZygorGuidesViewer:RegisterGuide("Zygor's Alliance Dailies Guides\\Icecrown\\Argent Tournament Grounds Aspirant Rank Dailies",[[
	...
	step //15
		...
		.talk Arcanist Taelis##33625
		.' You will only be able to accept, and turn in, 1 of these 3 daily quests per day:
		..turnin A Blade Fit For A Champion##13666 |or
		..turnin A Worthy Weapon##13669 |or
		..turnin The Edge of Winter##13670 |or
	step //16
		goto 76.5,19.4
		.talk Avareth Swiftstrike##33646
...
ZygorGuidesViewer:RegisterGuide("Zygor's Alliance Dailies Guides\\Icecrown\\Argent Tournament Grounds Valiant Rank Dailies",[[
	...
	step //
		...
		.talk Colosos##33593
		.' You will only be able to accept, and turn in, 1 of these 3 daily quests per day:
		..accept A Blade Fit For A Champion##13752 |daily
		..accept A Worthy Weapon##13753 |daily
		..accept The Edge Of Winter##13754 |daily
		only Draenei
	step //
		goto 76.1,19.2
		.talk Saandos##33655
	...
	step //
		...
		.talk Lana Stouthammer##33312
		.' You will only be able to accept, and turn in, 1 of these 3 daily quests per day:
		..accept A Blade Fit For A Champion##13741 |daily
		..accept A Worthy Weapon##13742 |daily
		..accept The Edge Of Winter##13743 |daily
		only Dwarf
	step //
		goto 76.7,19.4
	...
	step //
		...
		.talk Marshal Jacob Alerius##33225
		.' You will only be able to accept, and turn in, 1 of these 3 daily quests per day:
		..accept A Blade Fit For A Champion##13603 |daily
		..accept A Worthy Weapon##13600 |daily
		..accept The Edge Of Winter##13616 |daily
		only Human
	step //
		goto 76.5,19.1
	...
	step //
		...
		.talk Ambrose Boltspark##33335
		.' You will only be able to accept, and turn in, 1 of these 3 daily quests per day:
		..accept A Blade Fit For A Champion##13746 |daily
		..accept A Worthy Weapon##13747 |daily
		..accept The Edge Of Winter##13748 |daily
		only Gnome
	step //
		goto 76.6,19.8
...
ZygorGuidesViewer:RegisterGuide("Zygor's Alliance Dailies Guides\\Icecrown\\Crusader Title Guide (Unlocks More Dailies)\\Home Cities Exalted Reputation Guide",[[
	description This guide will help you to get Exalted reputation with the Darnassus, Exodar, Gnomeregan Exiles, Ironforge, and Stormwind factions.  You need to be exalted with these 5 reputations in order to earn your Crusader title and open up more daily quests.
	author support@zygorguides.com
	startlevel 77
	step //1
	...
	step //18
		...
		..accept Webwood Venom##9162/26/2010
	step //21
		goto 58.8,36.8
...
ZygorGuidesViewer:RegisterGuide("Zygor's Alliance Dailies Guides\\Events\\Noblegarden (April 4th - April 11th)\\Noblegarden Quests and Dailies",[[
	...
	step //
		'Leave out of the east exit of Dalaran to go outside to Teldrassil |goto Teldrassil |noway |c
	step //
...
ZygorGuidesViewer.AllianceDailiesInstalled=true