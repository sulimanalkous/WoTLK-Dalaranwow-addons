...
if GetLocale() == "frFR" then
	...
	FWL.MIN_DURATION_TT = "Minimum remaining duration cooldowns must have to be displayed in this cooldown timer instance.";
	FWL.MAX_DURATION = "Maximum duration";
	FWL.MAX_DURATION_TT = "Maximum remaining duration cooldowns must have to be displayed in this cooldown timer instance.";
