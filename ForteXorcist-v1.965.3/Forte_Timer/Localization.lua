...
if GetLocale() == "frFR" then
	...
	FWL.SHOW_WITHOUT_UNIT = "Show without unit";
...
elseif GetLocale() == "deDE" then
	...
	FWL.DISPLAY_MODES9 = "Spells statt Namen";
	FWL.DISPLAY_MODES9_TT = "Dies zeigt anstelle des Zielnamens den Namen des Spells in der Leiste. Wenn '"..FWL.DISPLAY_MODES7.."' aktiviert ist werden die Einheitennamen vor jeder Leistengruppe angezeigt.";
	FWL.DISPLAY_MODES10 = "Zeige nur Ziel/Focus";
	FWL.DISPLAY_MODES10_TT = "Alle Spells werden im Hintergrund überwacht und es werden nur die deines Zieles oder Focus angezeigt.";
...
--[[>>]]FWL.DISPLAY_TYPES2_TT = "Zeigt Schwachstellen wie den 'Verbesserter Schattenblitz' Debuff auf deinem Ziel als Powerup.";
	...
	FWL.SHARED_TYPE = "Gemeinsame Typen";
...
elseif GetLocale() == "koKR" then
	...
	FWL.DISPLAY_MODES9 = "유닛 이름표에 주문을 표기";
	FWL.DISPLAY_MODES9_TT = "타이머 바에 유닛(대상/주시대상/기타)의 이름대신 주문의 이름을 표시합니다.";
	FWL.DISPLAY_MODES10 = "대상/주시대상만 보기";
	FWL.DISPLAY_MODES10_TT = "모든 주문이 기록되지만 대상(/대상)과 주시대상(/주시)과 관련된 것만 표시합니다.";
